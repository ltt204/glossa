...
func (authRepo *authRepository) RefreshToken(ctx context.Context, req RefreshTokenRequest) (string, error) {
	accessToken, err := authRepo.refRepo.GenerateAcccessTokens(ctx, req.RefreshToken)
	if err != nil {
